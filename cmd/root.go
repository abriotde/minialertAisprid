...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&server, "server", "s", "localhost:8080", "The server to connect when in client mode (default). If no port specified, it connect on 8080 port." )
